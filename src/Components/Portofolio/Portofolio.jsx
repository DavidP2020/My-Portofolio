...
const Portofolio = () => {
  ...
  return (
    <section className="portofolio section" id="Portofolio">
      ...
      <div
        className={
          toggle === 1 ? "website-container-active" : "design-container-active"
        }
      >
        <Swiper
          ...
          modules={[Pagination]}
        >
          {Data.filter((a) => a.title.includes("Desain")).map(
            ({ id, image, title, desc }) => {
              return (
                <SwiperSlide className="porto-card" key={id}>
                  <img src={image} alt="" className="porto-img" />

                  <h3 className="porto-name">{title}</h3>
      ...
      <div
        className={
          toggle === 2 ? "website-container-active" : "design-container-active"
        }
      >
        <Swiper
          className="porto-container"
          ...
          modules={[Pagination]}
        >
          {Data.filter((a) => a.title.includes("Website")).map(
            ({ id, image, title, desc }) => {
              return (
                <SwiperSlide className="porto-card" key={id}>
